...
public class UIManager : Manager<UIManager>
{
    ...
    public Events.EventFadeComplete OnMainMenuFadeComplete;     // reference Unity event again (Mainmenu -> UIManager -> GameManager) 
    ...
    void HandleMainMenuFadeComplete(bool fadeOut)
    {
        ...
        OnMainMenuFadeComplete.Invoke(fadeOut);     // invoke the same event to pass the event from MainMenu to GameManager
    }
